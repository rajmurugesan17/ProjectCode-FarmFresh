...
<body>
	...
	<div class="bg">
	<h2><i>Farm Fresh is an online portal that helps you to find the right Buyer..<br>which makes your products more valuable..<br>
		Helps you to find the right seller..with the affordable price and high quality of goods..,</i></h2>
	</div>
</body>
</html>