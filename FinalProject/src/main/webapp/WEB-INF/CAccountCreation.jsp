...
<div class="logo"><img src="${pageContext.request.contextPath}/resources/images/logo.jpg" width="150px" height="115px"></div>
	...
	<form:form action="CustomerDetails" modelAttribute="accDetails">
	<tr>
	...
	<tr>
		<th>Age</th><td><form:input path="age" type="text" placeholder="Enter the Age.." pattern="[1-9]{1,}" title="Age should not be Zero or Negative" required="required"/></td>
	</tr>
	<tr>
		<th>Location</th><td><form:input path="location" placeholder="Enter the Location.."  pattern="[A-za-z ]{1,}" title="Location should contain A-z or a-z and space" type="text" required="required"/></td>
	</tr>
	<tr>
	...
	<tr>
		<th>EmailId</th><td><form:input path="emailId" type="email" placeholder="Enter the Email.." title="Eg:abc@gmail.com"  required="required"/></td>
	</tr>
	<tr>
