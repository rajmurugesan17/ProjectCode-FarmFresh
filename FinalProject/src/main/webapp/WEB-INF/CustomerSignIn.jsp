...
<div class="logo"><img src="${pageContext.request.contextPath}/resources/images/logo.jpg" width="150px" height="115px"></div>
	...
	<form action="cLogin">
	<tr>
		<th>UserName:</th><td><input type="text" name="uname" required="true" placeholder="Username"></td>
	</tr>
	<tr>
		<th>Password:</th><td><input type="password" name="password" required="true" placeholder="Password"></td>
	</tr>
	<tr>
